...
class SystemResource extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $resources = $this->checkMikrotikConnection->checkConnection()->query($query)->read();

        return view('admin.mikrotik.functions.system-resource', compact('resources'));
