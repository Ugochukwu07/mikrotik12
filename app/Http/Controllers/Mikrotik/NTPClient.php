...
class NTPClient extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        $clients = $this->checkMikrotikConnection->checkConnection()->query($query)->read();

        return view('admin.mikrotik.functions.ntp-client', compact('clients'));
    }
}
