                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    <div class="mt-5 md:mt-0 md:col-span-2">
                                        <div class="grid grid-cols-1 mt-5">
                                            ...
                                            <x-input name="name" class="bg-gray-100" value="{{ $user->name }}" disabled></x-input>
                                        </div>

                                        <div class="grid grid-cols-1 mt-5">
                                            <x-label for="email" value="{{ __('E-mail') }}"></x-label>
                                            @if(auth()->user()->isAdmin())
                                                <x-input name="email" value="{{ $user->email }}" type="email"></x-input>
                                            @else
                                        ...
                                        <div class="grid grid-cols-1 mt-5">
                                            ...
                                            <x-input name="company" value="{{ $user->company }}"></x-input>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 mt-5">
                                            ...
                                            <x-input name="postcode" value="{{ $user->postcode }}"></x-input>
                                        </div>
