                        ...
                        <form action="{{ route('users-store') }}" method="POST">
                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                ...
                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    ...
                                    @if(getSetting('using_service_zone') && !auth()->user()->isReseller())
                                        <div class="grid grid-cols-1 mt-5">
                                            <x-label for="service_zone_id" value="{{ __('Select zone') }}"></x-label>
                                            <x-select name="service_zone_id">
                                    ...
                                    @if(getSetting('using_customer_manager') && !auth()->user()->isReseller())
                                        <div class="grid grid-cols-1 mt-5">
                                            <x-label for="manager_id"
                                                     value="{{ __('Select customer manager') }}"></x-label>
                                            <x-select name="manager_id">
