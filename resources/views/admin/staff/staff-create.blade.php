    ...
    <div class="py-10">
        <div class="max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden sm:rounded-lg">
                <x-card-title title="{{ __('Add staff') }}"></x-card-title>
                    ...
                    <div class="grid rounded-lg w-11/12 md:w-9/12 lg:w-2/2">
                        <form action="{{ route('staff-store') }}" method="POST">
                            ...
                            <div class="md:grid md:grid-cols-3 md:gap-6">
                                <div class="md:col-span-1">
                                    <div class="flex">
                                        <h1 class="text-gray-600 font-bold md:text-xl text-xl">{{ __('Role') }}</h1>
                                    </div>
                                </div>

                                <div class="mt-5 md:mt-0 md:col-span-2">
                                    <div class="grid grid-cols-1">
                                        <x-label for="role_id" value="{{ __('Select role') }}"></x-label>
